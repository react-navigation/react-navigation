...
export { createNormalizedConfigs as createNormalizedConfigsForGetActionFromState } from './getActionFromState';
export { getFocusedRouteNameFromRoute } from './getFocusedRouteNameFromRoute';
export { getPathFromState } from './getPathFromState';
export { createNormalizedConfigs as createNormalizedConfigsForGetPathFromState } from './getPathFromState';
export { getStateFromPath } from './getStateFromPath';
export { createNormalizedConfigs as createNormalizedConfigsForGetStateFromPath } from './getStateFromPath';
