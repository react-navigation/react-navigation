...
describe('headerBackIcon', () => {
  test('renders with headerBackIcon image type', async () => {
    const Test = ({
      route,
      navigation,
    }: NativeStackScreenProps<StackParamList>) => (
    ...
    expect(getByText('Screen B')).toBeDefined();
  });

  test('headerBackIcon takes precedence over deprecated headerBackImageSource', async () => {
    const Test = ({
      route,
      navigation,
    }: NativeStackScreenProps<StackParamList>) => (
    ...
    const backIcon = {
      type: 'image' as const,
      source: { uri: 'https://example.com/new-icon.png' },
    };
          ...
          <Stack.Screen
            ...
            options={{
              ...
              headerBackImageSource: {
                uri: 'https://example.com/old-icon.png',
              },
            }}
          />
        </Stack.Navigator>
    ...
    fireEvent.press(getByText(/go to b/i));
    // The test passes if it renders without errors - headerBackIcon should be used
    expect(getByText('Screen B')).toBeDefined();
  });

  test('deprecated headerBackImageSource still works', async () => {
    const Test = ({
      route,
      navigation,
    }: NativeStackScreenProps<StackParamList>) => (
      ...
      <NavigationContainer>
        <Stack.Navigator>
          ...
          <Stack.Screen
            ...
            component={Test}
            options={{
              headerBackImageSource: { uri: 'https://example.com/icon.png' },
            }}
          />
        </Stack.Navigator>
      </NavigationContainer>
