...
export type BottomTabNavigationOptions = {
   ...
   *
   * On the `native` implementation, the largest value across tabs sets the
   * bar's icon box and smaller icons are inset to their own size; on the
   * `custom` implementation it sizes the icon (container width).
   *
   * @platform android
   */
