...
const linking: LinkingOptions<RootStackParamList> = {
  ...
  // Android (bare): adb shell am start -a android.intent.action.VIEW -d "rne+7://127.0.0.1:19000/--/simple-stack"
  // iOS (bare): xcrun simctl openurl booted rne+7://127.0.0.1:19000/--/simple-stack
  // The first segment of the link is the the scheme + host (returned by `Linking.makeUrl`)
  prefixes: [createURL('/')],
  // When not using Dev Client, launching app from the server has an internal URL
