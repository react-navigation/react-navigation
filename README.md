...
2. If you want to make any changes, make them and commit
3. Run `yarn lerna run prepare` to perform the build steps
4. Now `cd` to the package directory that you want to use (e.g. `cd packages/stack` for `@react-navigation/stack`)
5. Run `gitpkg publish` to publish the package to your repo
