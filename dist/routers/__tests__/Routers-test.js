var _jsxFileName = 'src/routers/__tests__/Routers-test.js';
    ...
    test('title is configurable using navigationOptions and getScreenOptions', function() {
      var FooView = (function(_React$Component) {
        ...
        function FooView() {
          ...
          return _possibleConstructorReturn(
            this,
            (FooView.__proto__ || Object.getPrototypeOf(FooView)).apply(
              this,
              arguments
            )
          );
      ...
      var BarView = (function(_React$Component2) {
        ...
        function BarView() {
          ...
          return _possibleConstructorReturn(
            this,
            (BarView.__proto__ || Object.getPrototypeOf(BarView)).apply(
              this,
              arguments
            )
          );
      ...
      var BazView = (function(_React$Component3) {
        ...
        function BazView() {
          ...
          return _possibleConstructorReturn(
            this,
            (BazView.__proto__ || Object.getPrototypeOf(BazView)).apply(
              this,
              arguments
            )
          );
      ...
      BazView.navigationOptions = function(_ref) {
        ...
        return { title: 'Baz-' + navigation.state.params.id };
      };
      var router = Router({
        Foo: { screen: FooView },
        Bar: { screen: BarView },
...
test('Handles no-op actions with tabs within stack router', function() {
  ...
  var state1 = TestRouter.getStateForAction({
  ...
  var state3 = TestRouter.getStateForAction(
...
test('Handles deep action', function() {
  ...
  var expectedState = {
    ...
    routes: [{ key: 'Init-id-0-2', routeName: 'Bar' }],
  };
