...
var _jsxFileName = 'src/views/Header/HeaderBackButton.js';
...
HeaderBackButton.defaultProps = {
  ...
  tintColor: _reactNative.Platform.select({ ios: '#037aff' }),
  truncatedTitle: 'Back',
...
var styles = _reactNative.StyleSheet.create({
  ...
  title: { fontSize: 17, paddingRight: 10 },
  icon:
    _reactNative.Platform.OS === 'ios'
      ? {
          height: 21,
  ...
  iconWithTitle: _reactNative.Platform.OS === 'ios' ? { marginRight: 5 } : {},
});
