var _jsxFileName = 'src/navigators/__tests__/StackNavigator-test.js';
...
var _StackNavigator = require('../StackNavigator');
...
describe('StackNavigator', function() {
  it('renders successfully', function() {
    var MyStackNavigator = (0, _StackNavigator2.default)(routeConfig);
    var rendered = _reactTestRenderer2.default
      .create(
        _react2.default.createElement(MyStackNavigator, {
  ...
  it('applies correct values when headerRight is present', function() {
    var MyStackNavigator = (0, _StackNavigator2.default)({
      Home: {
        screen: HomeScreen,
        navigationOptions: {
