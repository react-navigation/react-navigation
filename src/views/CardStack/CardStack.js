...
class CardStack extends React.Component {
    ...
    _isModal() {
        const {index, mode, transitionProps} = this.props

        const isBackNavigation = index < transitionProps.scenes.length - 1;
        const animationDefinerScene = isBackNavigation ? transitionProps.scenes[transitionProps.scenes.length - 1] : transitionProps.scene;
